...
import '../../../InterfaceFunc/screenOpeners/CustomerSide/previousOrdersOpener.dart';
...
class ALClientInputs extends StatefulWidget {
  static const routeName = "/ALClientInputs";
  const ALClientInputs({Key? key}) : super(key: key);

  @override
  State<ALClientInputs> createState() => _ALClientInputsState();
}

class _ALClientInputsState extends State<ALClientInputs> {
  final scaffoldKey = GlobalKey<ScaffoldState>();

  final GlobalKey<State<StatefulWidget>> _mapKey = GlobalKey();
  ...
  final OrderValues _orderValue = OrderValues();
  ...
  void getLocation() async {
    ...
    setState(() {
      globalMarkers.add(Marker(
        ...
        position: LatLng(double.parse(_currentLocationValues!.lat.toString()),
            double.parse(_currentLocationValues!.long.toString())),
      ));
    });
  }
    ...
    return Container(
      ...
      child: ElevatedButton(
          onPressed: () async {
            ...
            if ((now + 30.minutes).millisecondsSinceEpoch > _orderValue.dateValue!.millisecondsSinceEpoch) {
            ...
            for (int i = 0; i < locationsData.length; i++) {
              if (locationsData[i]["id"] == selectedLocationId) {
                ...
                if (ordersDataSnapshot.data() == null) {
                  ...
                  await orderFinalize(_orderValue, selectedLocation, deviceHeight, deviceWidth);
      ...
      children: [
        ...
        ListTile(
          ...
          onTap: () {
            ...
            previousOrdersOpener(context, deviceHeight, deviceWidth, mounted);
                  ...
                  onPressed: () async {
                    if (_currentLocationValues?.isNotNull()) {
                      ...
                      if (insertResult != -1) {
                        ...
                        if(!mounted) return;
                        showSnackBarInformation(deviceHeight, deviceWidth, context, "Location is saved successfully");
                        ...
                        if(!mounted) return;
                        showSnackBarInformation(deviceHeight, deviceWidth, context,  "Location can not be saved. It is either already saved or the address is not sufficient.",);
                      ...
                      showSnackBarInformation(deviceHeight, deviceWidth, context, "There are missing informations");
              ...
              SizedBox(
                ...
                child: Center(
                  child: CupertinoDatePicker(
                    ...
                    minimumDate: DateTime(dateTimeNow.year, dateTimeNow.month, dateTimeNow.day, dateTimeNow.hour, minMin),
