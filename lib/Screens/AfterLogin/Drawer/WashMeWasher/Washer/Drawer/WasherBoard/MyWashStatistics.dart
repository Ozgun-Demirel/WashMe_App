...
class MyWashStatistics extends StatelessWidget {
  static const routeName = "/MyWashStatistics";
  const MyWashStatistics({Key? key}) : super(key: key);
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const Text("There is no current order at the moment!"),
              ],
            ),
          ),
        )
