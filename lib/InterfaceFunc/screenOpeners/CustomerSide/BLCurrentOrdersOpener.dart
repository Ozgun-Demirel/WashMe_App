...
import '../../../FirebaseHelper/FirestoreHelpers/WasherHelpers/orderShifterHelper.dart';
  ...
  BLCurrentOrdersOpener(double deviceHeight, double deviceWidth, BuildContext context, bool mounted,
    ...
    replaced ? Navigator.of(context).pushReplacementNamed("/BLCurrentOrders", arguments: {"ordersInfo" : ordersInfo }) : Navigator.of(context).pushNamed("/BLCurrentOrders", arguments: {"ordersInfo" : ordersInfo });
